...
export const imagesData: ImageDataType[] = [
  ...
  { id: 3, src: ["sliding-tanks-1.png", "sliding-tanks-2.png", "sliding-tanks-3.png"], title: "Sliding Tanks Game", description: 'Fast, competitive game with up to 4 tasks sliding on ice.' },
]